...
class MS561101BA {
  public:
    MS561101BA();
    void init(uint8_t addr = MS561101BA_ADDR_CSB_LOW);
    float getPressure(uint8_t OSR = MS561101BA_OSR_4096);
    float getTemperature(uint8_t OSR = MS561101BA_OSR_4096);
    int32_t getDeltaTemp(uint8_t OSR = MS561101BA_OSR_4096);
    uint32_t rawPressure(uint8_t OSR = MS561101BA_OSR_4096);
    uint32_t rawTemperature(uint8_t OSR = MS561101BA_OSR_4096);
    int readPROM();
    void reset();
